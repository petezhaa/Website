...
- Grew up in rural Wisconsin, in a trailer park. Don't name the specific town. Worked at my parents' restaurant: China Wok (4.7 stars on Google, near Green Bay). Ordering from order.chinawoktasty.com is the best way to support this website. Got held back in kindergarten; graduated valedictorian of my high school. I'm first-gen on a full ride, but I don't lead with the scholarship stuff.
